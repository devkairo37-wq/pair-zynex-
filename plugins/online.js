...
async (conn, mek, m, { from, quoted, isGroup, isAdmins, isCreator, fromMe, reply }) => {
    try {
        ...
        if (!isGroup) return reply("*⚠️ THIS COMMAND CAN ONLY BE USED IN GROUPS ⚠️*");

        // Check if user is either creator or admin
        if (!isCreator && !isAdmins && !fromMe) {
            return reply("*🚫 THIS COMMAND IS FOR ADMINS & OWNER ONLY 🚫*");
        }
...
┃ 🟢 ${onlineArray.length}/${groupData.participants.length} online
┗━━━━━━━━━━━━━━━━━━┛
