...
cmd({
    pattern: "pair",
    alias: ["getpair", "pairing"],
    react: "✅",
    desc: "Get pairing code for KAIRO ZYNEX bot",
    category: "download",
    use: ".pair 509****",
    filename: __filename
...
cmd({
    pattern: "pair2",
    alias: ["getpair2", "reqpair"],
    react: "📉",
    desc: "Get pairing code for KAIRO ZYNEX bot (alt method)",
    category: "download",
    use: ".pair2 509XXX",
    filename: __filename
}, async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, senderNumber, reply }) => {
    try {
        ...
        const sentMessage = await conn.sendMessage(from, {
            ...
            caption: `- *Pairing Code*\n\nA notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your session id.\n\n*🔢 Pairing Code*: *${pairingCode}*\n\n> *Copy it from below message 👇🏻*`
        }, { quoted: m });
