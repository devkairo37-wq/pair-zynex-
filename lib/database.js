...
const DEFAULT_REJECT_MSG = '🔕 Your call was automatically rejected.';
const DEFAULT_STATUS_MSG = 'Hello from KAIRO ZYNEX';
...
const userConfigSchema = new mongoose.Schema({
    ...
    config: {
        ...
        REJECT_MSG: { type: String, default: DEFAULT_REJECT_MSG },
        ...
        AUTO_STATUS_MSG: { type: String, default: DEFAULT_STATUS_MSG },
...
async function getUserConfigFromMongoDB(number) {
    try {
        ...
        if (config) {
            ...
            // Configuration par défaut (alignée avec le schema ci-dessus)
            const defaultConfig = {
                ...
                AUTO_STATUS_MSG: DEFAULT_STATUS_MSG,
                AUTO_LIKE_EMOJI: ['❤️', '👍', '😮', '😎']
            };
